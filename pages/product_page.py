...
class ProductPage(BasePage):
    def add_product_to_basket(self):
        btn_add_basket = self.browser.find_element(*ProductPageLocators.ADD_TO_BASKET)
    ...
    def should_be_message_add_product(self):
        ...
        assert full_message == message_success_add_product,\
            f"expected '{product_name}' not equal '{message_success_add_product}'"
    ...
    def should_be_message_price_product(self):
        ...
        assert full_message == message_info_price_product,\
            f"expected '{product_price}' not equal '{message_info_price_product}'"
